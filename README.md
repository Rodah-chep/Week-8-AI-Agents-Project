# AutoParts Inc. AI Automation Pilot
...
3. Set API endpoints to your webhook.site URLs
4. Execute workflow

## Files
- `workflow.json` - Complete n8n workflow export
- `api-payloads.json` - Sample request/response data
- `simulation-guide.md` - Step-by-step testing instructions